...
- Soit $F$ et $G$ de sev de $E$ :   $F\perp G \Leftrightarrow \forall (x,y) \in G \times F,  \quad (x | y) =0$
...
- Une famille de vecteurs est dit orthogonal si tous les vecteurs de la famille sont orthogonaux entre eux.
...
$\forall i \in [ [1,m] ]$, $(x-y | v_{i}) = 0 \Leftrightarrow (x | v_{i}) = (y | v_{i})$
