...
$e^{i \pi}  =-1 \quad \quad e^{i2 \pi}=1 \quad \quad e^{i \frac{\pi}{2}}=i$ 
### Relations d'Euler 
$\forall \theta \in \mathbb{R}$ 
- $\displaystyle \cos(\theta)= \frac{e^{i \theta}+e^{-i \theta}}{2}$ 
- $\displaystyle \sin(\theta)= \frac{e^{i \theta}-e^{-i \theta}}{2i}$
### L'angle moitie
$\displaystyle 1+ e^{i \theta}=2\cos\left(\frac{\theta}{2}\right)e^{i \frac{\theta}{2}} \quad \quad  \quad \quad \quad \displaystyle 1-e^{i \theta}= -2i \sin\left(\frac{\theta}{2}\right)e^{i \frac{\theta}{2}}$ 
$\displaystyle e^{ip}+e^{iq}=2\cos \left( \frac{p-q}{2} \right) e^{i \frac{p+q}{2}} \quad \quad\displaystyle e^{ip}-e^{iq}=2i \sin \left( \frac{p-q}{2} \right) e^{i \frac{p+q}{2}}$
### Formule de Moivre
...
### Argument
$\theta = \arg(z)$
$\displaystyle \cos(\theta)= \frac{a}{\sqrt{a^{2}+b^{2}}} \quad \quad\displaystyle \sin(\theta)= \frac{b}{\sqrt{a^{2}+b^{2}}} \quad \quad \displaystyle \tan(\theta)= \frac{b}{a}$ 
$\displaystyle \arg(zz')= \arg(z)+\arg(z') \quad \quad\displaystyle \arg(z^{n})=n \arg(z) \quad \quad \displaystyle \arg \left( \frac{z}{z'} \right) = \arg(z)-\arg(z')$                            
![[image argument nombre complexe.svg|500]]
### Module
$\rho = |z|$ 
...
## Equations 
### Racine carre de un nombre complexe
Soit $X = \alpha + \beta i$ on pose $\delta = r+si$
et $\delta ^{2}=X \Leftrightarrow \begin{cases} |\delta^{2}| = |X| \\ Re(\delta^{2 })= Re(x) \\ Im(\delta^{2}) = Im(x)\end{cases} \Leftrightarrow \begin{cases} r^{2}+s^{2} = |X| \\ r^{2}-s^{2}= Re(x) \\ 2rs = Im(x)\end{cases}$
### Equations de 2èm dégrée 
si $\Delta \neq 0$ :   $\displaystyle z_{1}= \frac{-b-\delta }{2a}$ et $\displaystyle z_{2}= \frac{-b+\delta }{2a}$
