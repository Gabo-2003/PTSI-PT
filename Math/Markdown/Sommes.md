...
- $\displaystyle \cancel{\sum_{k=1}^{n} a_{k}\times b_{k} \neq \sum_{k=1}^{n} a_{k} \times \sum_{k=1}^{n} b_{k} }$ 
- $\displaystyle \cancel{\frac{1}{\displaystyle  \sum_{k=1}^{n} a_{k}} \neq \sum_{k=1}^{n} \frac{1}{a_{k}}}$
### Changement d'indice 
...
- $\displaystyle \forall x \neq 1, \quad \sum_{k=0}^{n} x^{k}=\frac{1-x^{n+1}}{1-x}$   si $x=1$  alors    $\displaystyle \sum_{k=0}^{n} x^{k}=n+1$ 
### Suite arithmétique 
...
- $\displaystyle (a+b)^{n} = \sum_{k=0}^{n} \begin{pmatrix} n \\ k \end{pmatrix} a^{n-k} b^{k} =\sum_{k=0}^{n} \begin{pmatrix} n \\ k \end{pmatrix} a^{k} b^{n-k}$  avec  $(a,b) \in \mathbb{R}$
