...
$+: E^{2}\longrightarrow E \, ; \quad (u,v)\longmapsto u+v$ 
### Loi de composition externe
$\cdot : \mathbb{K}\times E \longrightarrow E \,; \quad (\lambda, u) \longmapsto \lambda u$ 
### Définition
...
##### Théorème de l'unicité de la décomposition du vecteur nulle
La somme $E_{1} + E_{2} + \ldots + E_{p}$ est directe $\Leftrightarrow \forall (x_{1},x_{2},\ldots,x_{p}) \in E_{1} \times E_{2} \times \ldots \times E_{p},$
$\quad x_{1}+x_{2}+\ldots+x_{p} = 0 \Rightarrow x_{1}=x_{2}=\ldots=x_{p} = 0$ 
