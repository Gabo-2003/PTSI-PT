...
![[image diagramme predominance.png|400]]
...
#### Acide forte
Dissociation en sa base et en protons totale.
- $pKa < 0$
#### Base forte 
...
#### Réaction totale 
- Règle du gamma
![[image reaction totale.png|200]]
#### Réaction limité
- Gamma inversé
![[image reaction limite.png|150]]
### Calcule du $pH$ 
...
### Précipité 
C'est une solide en équilibre avec la phase aqueuse, formé par une réaction de précipitation. 
#### Déclenché par :
...
![[image diagramme existance.png|500]]
### Solubilité
