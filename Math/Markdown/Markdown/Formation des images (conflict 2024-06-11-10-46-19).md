...
### Aplanétisme
Un objet orthogonal à l'axe optique donne une image orthogonale à l'axe. 
...
##### Conditions de Gauss
Rayon de faible inclinaison par rapport à l'axe optique et point d'incidence proche de l'axe optique.

## Miroir plan
Seule système rigoureusement stigmatique et aplanétique.
...
#### Distance focal
La distance focal d'une lentille est la distance $f'=\overline{OF'}$ , $f = \overline{OF}$
...
- $\displaystyle \gamma = \frac{\underline{F'A'}}{F'O} = \frac{\underline{FO}}{\underline{FA}}$  
#### Relations de Descartes (origine au centre)
$\displaystyle \frac{1}{\overline{OA'}}- \frac{1}{\overline{OA}}= \frac{1}{\overline{OF'}} \frac{1}{f'}=V$ 
- $\displaystyle \gamma = \frac{\overline{OA'}}{\overline{OA}}$ 
### Projection d'un objet réel par une lentille convergente
#### Position de la lentille 
![[image position lentille.png|300]]

$\begin{align*} \frac{1}{\overline{OA'}}- \frac{1}{\overline{OA}} &= \frac{1}{f'} \\ \frac{1}{D-x}- \frac{1}{-x}&=\frac{1}{f'} \\ \frac{D}{x(D-x)} &= \frac{1}{f'} \\ -x^{2}+Dx -f'D&=0 \end{align*}$  

$\begin{align*} x_{1}=\frac{D-\sqrt{D(D-4f')}}{2} \\ x_{2}=\frac{D+\sqrt{D(D-4f')}}{2} \end{align*}$
### Grandissement de l'image
$\displaystyle \gamma = \frac{\overline{A'B'}}{\overline{AB}} = \frac{\overline{OA'}}{\overline{OA}} = \frac{D-x}{-x} = 1- \frac{D}{x}$ 
### Qualité de l'image
