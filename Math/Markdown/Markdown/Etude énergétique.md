...
#### Motrice : 
$\mathcal{P}(\overrightarrow{f})>0$ 
#### Résistante : 
$\mathcal{P}(\overrightarrow{f})<0$
### Travail 
#### Travail élémentaire
$\delta W(\overrightarrow{f})=\overrightarrow{f}\cdot \overrightarrow{dl} = \mathcal{P}(\overrightarrow{f}) \cdot dt$  en $J$ 
