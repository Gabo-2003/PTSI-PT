...
$\displaystyle \underline{H}(\omega)= \dfrac{1}{1+ j \frac{\omega}{\omega_{0}}}$     
$G(\omega)= \dfrac{1}{\sqrt{1+ (\frac{\omega}{\omega_{0}})^{2}}}$  
$\displaystyle\varphi(\omega)= -\arctan\left(\frac{\omega}{\omega_{0}}\right)$
- $G_{dB}(\omega)= -10 \log(1+(\frac{\omega}{\omega_{0}})^{2})$ 
### Gain 
...
$\displaystyle \underline{H}(\omega)= \frac{H_{0}}{1+j \frac{\omega}{\omega_{0}}}$  pente de $-20 dB/decade$ 
### Passe-haut
Coupe les bas fréquences.
$\displaystyle \underline{H}(\omega)= H_{0} \frac{j \frac{\omega}{\omega_{0}}}{1+ j \frac{\omega}{\omega_{0}}} = \frac{H_{0}}{1-j \frac{\omega_{0}}{\omega}}$  pente de $20 dB/decade$ 
### Filtre  dérivateur 
...
## Filtres d'ordre 2
### Passe-bas
$\displaystyle\underline{H}(\omega)= \frac{H_{0}}{1+j\frac{\omega}{Q\omega_{0}}+ (j\frac{\omega}{\omega_{0}})^{2}}$   pente $-40 dB / deca$ 
...
### Passe-bande
$\displaystyle\underline{H}(\omega)= H_{0} \frac{j \frac{\omega}{Q\omega_{0}}}{1+j\frac{\omega}{Q\omega_{0}} + (j\frac{\omega}{\omega_{0}})^{2} } = \frac{H_{0}}{1+jQ(\frac{\omega}{\omega_{0}} - \frac{\omega_{0}}{\omega})}$    
- pente $\pm 20 dB / deca$ 
