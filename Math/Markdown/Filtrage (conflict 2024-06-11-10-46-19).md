...
### Passe-bande
$\displaystyle\underline{H}(\omega)= G_{0} \frac{j \frac{1}{Q} \frac{\omega}{\omega_{0}}}{1+j\frac{1}{Q} \frac{\omega}{\omega_{0}} + (j\frac{\omega}{\omega_{0}})^{2} } = \frac{G_{0}}{1+jQ(\frac{\omega}{\omega_{0}} - \frac{\omega_{0}}{\omega})}$    
- pente $\pm 20 dB / deca$ 
